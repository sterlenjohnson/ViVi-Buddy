...
interface BasicModeToggleProps {
    isUnified: boolean;
    onToggle: () => void;
    systemRAMAmount: number;
    setSystemRAMAmount: (value: number) => void;
    gpuBackend: string;
    setGpuBackend: (backend: string) => void;
}

const BasicModeToggle: React.FC<BasicModeToggleProps> = ({
    isUnified,
    onToggle,
    systemRAMAmount,
    setSystemRAMAmount,
            ...
            <div className="mb-4 p-3 rounded-lg shadow-inner bg-slate-700">
                ...
                <div className="flex items-center gap-3">
                    ...
                    <input
                        ...
                        value={systemRAMAmount}
                        onChange={(e) => setSystemRAMAmount(Number(e.target.value))}
                        className="w-20 rounded px-2 py-1 text-center text-xs text-white bg-slate-600"
                    />
